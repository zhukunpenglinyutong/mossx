const enPart1 = {
  ...
  messages: {
    ...
    threadRecoveryThreadNotFound: "This conversation points at a stale thread handle. Historical Codex sessions often cannot revive the old thread directly; if a previous prompt is available, recover and resend it into an available conversation.",
  ...
  composer: {
    ...
    readinessContextFileReference: "{{count}} file reference(s) linked for this send",
