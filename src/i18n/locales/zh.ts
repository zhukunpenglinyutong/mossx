const zh = {
  ...
  home: {
    ...
    noAgentActivity: "暂无代理活动",
    startThreadToSee: "开始一个对话以查看最新响应。",
    openProject: "打开项目",
    addWorkspace: "添加工作区",
  ...
  settings: {
    ...
    // Codex 部分
    codexTitle: "Codex",
    codexDescription: "配置 CodexMonitor 使用的 Codex CLI 并验证安装。",
    ...
    remoteBackendDesc: "单独启动守护进程并将 CodexMonitor 指向它（host:port + token）。",
