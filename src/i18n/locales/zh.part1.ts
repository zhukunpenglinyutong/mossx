const zhPart1 = {
  ...
  settings: {
    ...
    runtimePoolDescription: "统一查看 Codex / Claude Code 受管 runtime 的 lease、回收候选、进程归因与人工干预状态。",
    ...
    runtimeBudgetTitle: "Codex 容量与保温预算",
    runtimeBudgetDescription:
      "当前这组预算只作用于 Codex 受管 runtime。Claude Code 仍纳入观测与实例管理，但不参与这里的容量配置。",
    runtimeMaxHot: "Codex Hot 上限",
    runtimeMaxHotHelp:
      "允许同时保持可直接复用的 Codex 热实例数量。更大更快，但会更吃内存。",
    runtimeMaxWarm: "Codex Warm 上限",
    runtimeMaxWarmHelp:
      "允许保留的 Codex 温实例数量。Warm 不活跃，但比 Cold 更容易回温。",
    runtimeWarmTtl: "Codex Warm TTL（秒）",
    runtimeWarmTtlHelp:
      "Codex Warm 实例在无人使用时最多保留多久，超时后自动回收到 Cold。",
