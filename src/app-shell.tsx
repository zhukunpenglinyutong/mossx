...
const RADAR_STORE_NAME = "leida" as const;
const SESSION_RADAR_RECENT_STORAGE_KEY = "sessionRadar.recentCompleted" as const;
...
function buildRadarCompletionId(workspaceId: string, threadId: string) {
  return `${workspaceId}:${threadId}`;
}

function resolveLatestUserMessage(items: unknown): string {
...
function parsePersistedRadarRecentEntry(raw: unknown): PersistedRadarRecentEntry | null {
