...
- [ ] 1.3 Re-run `npm run lint`, `npm run typecheck`, and targeted feature tests to validate the tail batch and confirm repository-wide exhaustive-deps warnings drop to zero.
