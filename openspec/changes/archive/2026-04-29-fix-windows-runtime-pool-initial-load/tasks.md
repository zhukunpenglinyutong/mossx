...
- [x] 6.4 [P0][depends: 2-4][input: Windows cold launch][output: manual verification notes][verify: manual] Verify Windows cold launch with `runtimeRestoreThreadsOnlyOnLaunch=true`, immediate Settings > Runtime entry, rapid section switching, and true-empty case.
