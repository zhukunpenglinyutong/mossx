...
- [x] 6.4 [P1][depends: 6.1,6.2][input: running app][output: manual smoke notes][verify: checklist] Smoke test macOS-style and non-macOS-style display labels, Settings edit/clear, session next/previous, sidebars, runtime console, terminal, and files surface.
