# claude-concurrent-realtime-session-isolation Specification

## Purpose

TBD - synced from change fix-claude-concurrent-realtime-isolation. Update Purpose after archive.
