...
Repository-owned startup compatibility defaults MUST behave as additive Linux-only guards rather than broad environment overrides.
...
- **THEN** the Linux startup compatibility guard MUST NOT inject Linux-specific `WEBKIT_*` fallback env
