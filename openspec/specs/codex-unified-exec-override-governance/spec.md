...
Define how desktop-managed Codex unified_exec policy follows official defaults, supports explicit runtime-scoped overrides, and repairs legacy global config mutations safely.
