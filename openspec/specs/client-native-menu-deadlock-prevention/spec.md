# client-native-menu-deadlock-prevention Specification

## Purpose
Prevent renderer-owned business menus and backend menu registry updates from reintroducing native popup deadlock risks in the Tauri desktop client.
